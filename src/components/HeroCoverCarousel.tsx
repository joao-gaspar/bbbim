  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[420px] h-[280px] flex items-center justify-center">
        ...
        <button
          onClick={prevSlide}
          className="absolute -left-5 z-20 w-9 h-9 rounded-full bg-white/90 shadow-md border border-border flex items-center justify-center text-slate-700 hover:text-primary hover:scale-110 transition-all cursor-pointer"
        ...
        <button
          onClick={nextSlide}
          className="absolute -right-5 z-20 w-9 h-9 rounded-full bg-white/90 shadow-md border border-border flex items-center justify-center text-slate-700 hover:text-primary hover:scale-110 transition-all cursor-pointer"
        ...
        <div key={currentSet.id} className="flex gap-4 md:gap-6 items-center transition-all duration-500 ease-in-out">
          
          {/* Left Book Cover Card */}
          <Link
            href={`/livro/${currentSet.slugLeft}`}
            className="group relative w-36 sm:w-40 h-52 sm:h-56 rounded-xl overflow-hidden shadow-2xl origin-bottom -rotate-6 transform hover:rotate-0 hover:scale-105 transition-all duration-300 border border-slate-200/80 bg-white flex flex-col justify-between"
          >
            {/* Cover Image */}
          ...
          <Link
            ...
            className="group relative w-36 sm:w-40 h-52 sm:h-56 rounded-xl overflow-hidden shadow-2xl rotate-6 transform hover:rotate-0 hover:scale-105 transition-all duration-300 border border-slate-200/80 bg-white flex flex-col justify-between"
          >
            {/* Cover Image */}
            <div className="relative w-full h-full bg-slate-100 flex items-center justify-center overflow-hidden">
              {/* eslint-disable-next-line @next/next/no-img-element */}
